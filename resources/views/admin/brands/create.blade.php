<x-admin-layout>
    <x-slot name="title">Tambah Merek HP - Admin Secondbray</x-slot>
    <x-slot name="header">Tambah Merek HP Baru</x-slot>
            ...
            <form action="{{ route('admin.brands.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="Contoh: Samsung, iPhone, Xiaomi">
                        @error('name')
